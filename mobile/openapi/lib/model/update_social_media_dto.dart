...
class UpdateSocialMediaDto {
  /// Returns a new [UpdateSocialMediaDto] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is UpdateSocialMediaDto &&
  ...
  @override
  String toString() => 'UpdateSocialMediaDto[ownerId=$ownerId, description=$description, followers=$followers, following=$following, id=$id, lastDownloaded=$lastDownloaded, lastDownloadedNode=$lastDownloadedNode, name=$name, personId=$personId, platform=$platform, platformUserId=$platformUserId, platformUserIdHash=$platformUserIdHash, posts=$posts, thumbnailPath=$thumbnailPath, updatedAt=$updatedAt, url=$url]';
  ...
  /// Returns a new [UpdateSocialMediaDto] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static UpdateSocialMediaDto? fromJson(dynamic value) {
    upgradeDto(value, "UpdateSocialMediaDto");
    if (value is Map) {
  ...
  static List<UpdateSocialMediaDto> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <UpdateSocialMediaDto>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = UpdateSocialMediaDto.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, UpdateSocialMediaDto> mapFromJson(dynamic json) {
    final map = <String, UpdateSocialMediaDto>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = UpdateSocialMediaDto.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of UpdateSocialMediaDto-objects as value to a dart map
  static Map<String, List<UpdateSocialMediaDto>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<UpdateSocialMediaDto>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = UpdateSocialMediaDto.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
